package ae.zerotone.gateway.assist.test;
...
public class ApiTest {
  ...
  public void test_register_gateway() {
    ...
    String resultStr =
        HttpUtil.post("http://localhost:8001/wg/admin/config/registerGateway", paramMap, 3500);
  ...
  public void test_pullApplicationSystemRichInfo() {
    ...
    String resultStr =
        HttpUtil.post(
            "http://localhost:8001/wg/admin/config/queryApplicationSystemRichInfo", paramMap, 3500);
