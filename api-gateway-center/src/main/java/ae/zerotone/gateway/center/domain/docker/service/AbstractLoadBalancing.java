package ae.zerotone.gateway.center.domain.docker.service;
...
public abstract class AbstractLoadBalancing implements ILoadBalancingService {
  ...
  public void updateNginxConfig(NginxConfig nginxConfig) throws Exception {
    ...
    // 2. 复制 Nginx 配置文件
    // copyDockerFile(nginxConfig.getApplicationName(), containerFilePath,
    // nginxConfig.getLocalNginxPath());
  ...
  protected abstract void copyDockerFile(
      String applicationName, String containerFilePath, String localNginxPath)
      throws InterruptedException, IOException;

  protected abstract void refreshNginxConfig(String nginxName)
      throws InterruptedException, IOException;
}
