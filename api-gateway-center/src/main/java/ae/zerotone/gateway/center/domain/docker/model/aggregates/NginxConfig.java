package ae.zerotone.gateway.center.domain.docker.model.aggregates;
...
public class NginxConfig {
  ...
  public NginxConfig(
      ...
      String nginxName,
      String localNginxPath,
      String remoteNginxPath,
      List<UpstreamVO> upstreamList,
  ...
  public NginxConfig(List<UpstreamVO> upstreamList, List<LocationVO> locationList) {
    ...
    this.localNginxPath =
        "/Users/andying/github/maloong-zhang/api-gateway/api-gateway-center/doc/data/nginx/nginx.conf";
