...
public class LoadBalancingManage {
  ...
  public void copy() throws IOException {
    ProcessBuilder pb =
        new ProcessBuilder(
            ...
            "cp",
            "/nginx.conf",
            "host:/Users/fuzhengwei/1024/KnowledgePlanet/api-gateway/api-gateway-center/doc/data/nginx/nginx.conf");
    pb.start();
  }
  ...
  public void updateNginxConfig() {
    ...
    upstreamList.add(
        new UpstreamVO(
            "api01", "least_conn;", Arrays.asList("192.168.1.102:9001;", "192.168.1.102:9002;")));
